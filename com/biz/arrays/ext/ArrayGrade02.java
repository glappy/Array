...
public class ArrayGrade02 {
	...
	public static void main(String[] args) {
		...
		for (int i = 0; i < arrGS.length; i++) {
			...
			/*
			 * System.out.print( arrGS[i].gradeVO.getStrNum() + "\t"); System.out.print(
			 * arrGS[i].gradeVO.getIntKor() + "\t"); System.out.print(
			 * arrGS[i].gradeVO.getIntEng() + "\t"); System.out.print(
			 * arrGS[i].gradeVO.getIntMath() + "\t"); System.out.print(
			 * arrGS[i].gradeVO.getIntSci() + "\t"); System.out.print(
			 * arrGS[i].gradeVO.getIntSum() + "\t"); System.out.print(
